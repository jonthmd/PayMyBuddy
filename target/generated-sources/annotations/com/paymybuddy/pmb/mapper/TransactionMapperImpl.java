...
public class TransactionMapperImpl implements TransactionMapper {
    ...
    public TransactionDTO transactionToTransactionDTO(Transaction transaction) {
        ...
        transactionDTO.setSender( userToUserDTO( transaction.getSender() ) );
        transactionDTO.setReceiver( userToUserDTO( transaction.getReceiver() ) );
    ...
    public Transaction transactionDTOToTransaction(TransactionDTO transactionDTO) {
        ...
        transaction.setSender( userDTOToUser( transactionDTO.getSender() ) );
        transaction.setReceiver( userDTOToUser( transactionDTO.getReceiver() ) );
